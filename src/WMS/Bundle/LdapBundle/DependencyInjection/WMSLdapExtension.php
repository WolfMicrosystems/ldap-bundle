<?php
namespace WMS\Bundle\LdapBundle\DependencyInjection;

use WMS\Bundle\LdapBundle\Ldap\Configuration as LdapConfig;
use WMS\Bundle\LdapBundle\Ldap\Connection;
